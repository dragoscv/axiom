# AXIOM v1 changelog (1.0.x — superseded, archived)

> Archived verbatim from the root `CHANGELOG.md` on 2026-09-21 (D-31). v1 is deprecated on npm and receives no fixes; see [`MIGRATION.md`](../../../MIGRATION.md). The v2 changelog index is the root [`CHANGELOG.md`](../../../CHANGELOG.md).
